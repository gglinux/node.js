 ...
 */
 ...
 module.exports = function(){
	...
	//查询用户是否存在
	this.selectuser = function(username, password){
		var sql = "select * from user where nick_name ='" + username + "' and password = '" + password+"'";
	...
	function __constructor(){
		// var dbConfig = Util.get('../conf/config.json', 'db');
